  ...
  return (
    <div className="relative">
      ...
      <input
        ...
        className="w-full bg-white/5 border border-white/8 rounded-lg pl-9 pr-8 py-2.5 text-base md:text-sm text-white placeholder-neutral-500 focus:outline-none focus:border-accent-600/60 focus:bg-white/8 transition-colors"
      />
      {value && (
        <button
          onClick={() => onChange('')}
